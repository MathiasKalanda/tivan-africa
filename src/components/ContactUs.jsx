  ...
  return (
    <div className="mt-24">
      <div className="my-10 mx-15 ">
        <div className="bg-orange-600 py-3 px-4 w-full mt-10 text-3xl text-white  rounded-4xl text-center font-bold">
          Contact Us
        </div>
      </div>
      <div className="flex flex-col md:flex-row md:justify-center md:items-center">
        {" "}
        <div className=" m-10 w-full flex flex-col items-start md:items-center">
        ...
        <div className="max-w-3xl mx-auto my-12 p-6   rounded-xl  w-full">
